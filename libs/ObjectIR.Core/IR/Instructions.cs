...
public sealed class NewObjectInstruction : Instruction
{
    ...
    public NewObjectInstruction(TypeReference type, List<TypeReference>? parameterTypes = null) : base(OpCode.Newobj)
    {
        Type = type;
        ParameterTypes = parameterTypes ?? new List<TypeReference>();
    }
